    ...
    <div class="mt-4 container-fluid mw-100" style="width: 400px">
      ...
      <form>
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="exampleInputPassword2" placeholder="Password" v-model="confirmPasswordInput">
        </div>
        <div class="form-group">
          <button type="submit" class="btn btn-success" @click.prevent="handleSubmit">Sign up</button>
          <router-link to="/login" class="btn btn-outline-secondary ml-2">Log in</router-link>
        </div>
      </form>
    </div>
  `
